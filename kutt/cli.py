...
class Kutt:
    ...
    def __init__(self):
        try:
            ...
            if sys.platform == "win32":
                ...
                with open(
                    self._app_data + "\\kutt-cli\\config.toml", "w"
                ) as config_file:
    ...
    def config(self, action=None, arg1=None, arg2=None):
        ...
        if action == "api":
            ...
            print(
                "use config with following commands (Leave host blank for default kutt host)",
